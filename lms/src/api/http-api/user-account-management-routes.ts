/**
* @description User management routes for course relationship management
* @version 1.0
...
import { IStudentLecturerRelationShip, IUser, routeSecurityLevel } from "../../logic/lms-interfaces";
import path from 'path';
import { connectUser, generateToken, serializeUserDataResponse, encrytpUserPassword } from '../../logic';
