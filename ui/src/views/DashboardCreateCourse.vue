<template>
  <DashboardTemplate>
    <div class="container px-md-5 py-3">
        <form class="rounded bg-body p-3" @submit.prevent="createCourse">
          <!-- Form Head Row -->
          <div class="row">
            <div class="col">
            ...
            <div class="col-auto d-flex">
              ...
              <router-link class="h3 text-danger ms-3" :to="{ name: 'Courses' }"><i class="bi-x-circle"></i></router-link>
            </div>
          </div>
          <hr>
          <!-- End Form Head Row -->
          ...
          <div class="row p-3">
            ...
            <!-- <div class="col-md-4 p-2">
              ...
              <p class="text-muted" style="font-size: .85em"><small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
              tempor incididunt ut labore et dol.</small></p>
              ...
              <div class="content-drag bg-light p-2 rounded-4">
                <div class="drag-zone p-3 rounded-4 text-center" style="background-color: #F7EBFF; border: 2px dashed #ccc;">
                  ...
                  <p style="font-size: .85em">
                    <small>Drag your course content <strong>CSV | JSON</strong> here to start uploading</small>
                  </p>
                  <div class="row my-4">
                    <div class="col-5"><hr></div>
