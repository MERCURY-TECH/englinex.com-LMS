          ...
          <div class="col-md-8 d-none d-md-block">
            <div class="row h-100" style="padding-left: 10px;">
              ...
              <div class="col-md-7 text-center pt-5"
                ...
                <p class="h1 text-light fw-bold mt-5" style="font-family: 'Raleway', sans-serif; text-align: left;">Learn
                  in a glance</p>
                <p style="text-align: left; font-size: .9em;" class="text-light">
                  <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                    labore et dolore magna aliqua. Ut ut labore et dolore magna aliqua</small>
                </p>
