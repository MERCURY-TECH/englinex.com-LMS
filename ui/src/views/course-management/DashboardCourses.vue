      ...
      <div class="row">
        <div class="col-md-3 mb-4">
          <div class="card pt-2 px-3">
            ...
            <div class="row">
              <div class="col">
                <p class="h3 fw-bold">{{ courseStore.courses.length }}</p>
              </div>
              <div class="col-auto">
                <div class="p-2 text-center" style="
        ...
        <div class="col-md-12 rounded bg-body mb-3">
          <div class="row px-3 pb-3 pt-3">
            <div class="col px-3 pt-1">
              <p class="h4 fw-bold">Courses</p>
            </div>
            <div class="col-auto">
              <router-link class="btn btn-sm primary-button-outline px-5" :to="{ name: 'CreateCourse' }">
                New
              </router-link>
            </div>
          </div>
          <div class="px-md-2 pb-5">
            ...
            <div class="my-2">
              <table class="w-100">
                <tbody>
                  <tr v-for="course in courseStore.courses" :key="course._id" class="table-row"
                    ...
                    <td class="pt-3 px-3 ps-md-5">
                      <p>
                        <span v-if="course.isPublic">
                          <span class="badge pill text-purple primary-bg-subtle h2 px-2 me-1">
                            Active</span>
                          <span class="badge pill text-info-emphasis bg-info-subtle h2 px-2">
                            Public</span>
                        </span>
                        <span v-else>
                          <span class="badge pill text-danger-emphasis bg-danger-subtle h2 px-2 me-1">
                            Inactive</span>
                          <span class="badge pill text-secondary-emphasis bg-secondary-subtle h2 px-2">Not
                            Published</span>
                        </span>
                      </p>
                    </td>
                    <td class="pt-3 px-3">
                      <p class="table-action">
                        ...
                        }" class="primary-text px-2"><i class="bi-pencil-square"></i></router-link>
...
onMounted(async () => {
  loader.value = true;
  let statusObj = await courseStore.getAllCourses();
