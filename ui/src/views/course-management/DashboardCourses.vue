      ...
      <div class="row">
        ...
        <div class="col-md-3 mb-4">
          <div class="card pt-2 px-3">
            ...
            <div class="row">
              <div class="col">
                <p class="h3 fw-bold">{{ courseList.length }}</p>
              </div>
              <div class="col-auto">
                <div class="p-2 text-center"
                  style="background-color: lightblue; border-radius: 50%; padding-top: 17px; height: 40px; width: 40px;">
        ...
        <div class="col-md-12 rounded bg-body mb-3">
          <div class="row px-3 pb-3 pt-3">
            ...
            <div class="col-auto">
              <router-link class="btn btn-sm primary-button-outline px-5" :to="{ name: 'CreateCourse' }"> New
              </router-link>
            </div>
          </div>
                  ...
                  <tr v-for="course in courseList" :key="course._id" class="table-row" style="margin-bottom: 10px;">
                    ...
                    <td class="pt-3 px-3">
                      <p class="table-action">
                        <router-link :to="{ name: 'EditCourse', params: { id: course._id } }" class="primary-text px-2"><i
...
import router from "@/router";
    ...
    const fetchData = () => {
      axios.get('get-all-courses/')
        .then(response => {
          courseList.value = response.data.message.courses;
        })
        .catch(error => {
          console.log(error);
        });
