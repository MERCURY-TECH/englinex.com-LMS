<template>
    <form method="POST" class="text-center p-3">
        ...
        <div class="row ">
            <div class="col-12 p-1 mt-2">
                <div class="mb-3 form-check">
                    <input @keyup="handleChange" name="acceptPolicy" :value="this.acceptPolicy" type="checkbox"
        ...
        <button @click="handleSubmit" class="btn primary-button-outline form-control">
            Signup
