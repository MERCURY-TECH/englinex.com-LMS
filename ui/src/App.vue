<template>
  ...
  <strong>Holy guacamole!</strong> Please activate your account
...
.header-link .nav-link:hover .primary-dropdown-arrow {
  color: #000;
  padding-right: 4px;
}
...
.primary-button {
  background-color: #A01FEF !important;
  border-color: #A01FEF !important;
  color: #fff !important;
}
